...
async def on_chat_start():
    ...
    if user.metadata.get("role") == "admin":
        if chat_profile == "Document Query":
            # System prompt for Document Query chat profile
            system_prompt = "You are the Document Query assistant."
            
            # Entire processing logic for Document Query
            files = None
            ...
            # Default system prompt for any other profile
            system_prompt = "You are the Document Query assistant."
    else:
        # Default system prompt for non-admin users
        system_prompt = "You are the Document Query assistant."
